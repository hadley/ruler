...
- All rule packs are actually applied to __keyed__ version of data (see [keyholder](http://github.com/echasnovski/keyholder)) for reasons described in "Rule Packs" vignette. If input has keys they are removed and _id key_ is created.
