---
title: "Expose data to rules"
author: "Evgeni Chasnovski"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Expose data to rules}
...
This vignette will describe the actual validation step of `ruler` workflow and show some examples of what one can do with validation results Packs from vignette about rule packs will be used for this.
...
For exposing data to rules use `expose()`. It takes data as a first argument and then rule packs (in pure form or inside list at any depth) to be applied to it. Simple example:
